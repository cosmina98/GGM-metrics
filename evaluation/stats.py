...
def degree_stats(graph_ref_list, graph_pred_list, is_parallel=True):
    ...
    mmd_dist_time=elapsed.total_seconds()
    #if PRINT_TIME:
        #print('Time computing degree mmd: ', elapsed)
    return mmd_dist,mmd_dist_time
...
def eval_graph_list(graph_ref_list, grad_pred_list, methods=None):
    ...
    for method in methods:
        results[method+"_mmd"],results[method+"_mmd_time"] = METHOD_NAME_TO_FUNC[method](graph_ref_list, grad_pred_list, is_parallel=True)
